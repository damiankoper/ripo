...
if __name__ == "__main__":
    ...
    #c.genAugmentedDataSet("data/training/dataset/trimmed_data", "data/training/dataset/augmented_data")

    #c.createTrainingData("data/training/dataset/augmented_data")

    #c.training("data/training/trained_model")
